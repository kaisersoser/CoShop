...
export function Pending() {
  return (
    <ul style={{ listStyle: 'none', padding: 0, background: 'var(--surface)' }}>
      <ItemRow item={{ ...baseItem, isPurchased: false }} />
    </ul>
  );
}

// Purchased item: cyan checked state, strikethrough name, muted opacity.
...
export function MixedGroup() {
  return (
    <ul style={{ listStyle: 'none', padding: '0 8px', background: 'var(--surface)' }}>
      <ItemRow item={{ ...baseItem, isPurchased: false }} />
